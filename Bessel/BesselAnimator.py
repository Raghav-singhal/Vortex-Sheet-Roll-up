# -*- coding: utf-8 -*-
"""
Created on Tue Jul 14 22:32:01 2015
...
#    Y1=u[1,:]
#    
    X1=np.loadtxt("XdataBessel.txt")
    Y1=np.loadtxt("YdataBessel.txt")
...
#    Y9=np.loadtxt('D01inymindata.txt')
    ...
    ax = plt.axes(xlim=(-1.7, 2.), ylim=(-1.7,2.3))
...
# call the animator.  blit=True means only re-draw the parts that have changed.
    ...
    anim.save('circleBR.mp4', fps=20)#,dpi=200)
    plt.show()
